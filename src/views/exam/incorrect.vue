  ...
  <div class="app-container">
    ...
    <el-row>
      <el-col :span="20" :offset="2">
        <div class="subject-content" v-for="tempIncorrectAnswer in list" :key="tempIncorrectAnswer.id">
          <div class="subject-content-option">
            <div class="subject-title">
              <span class="subject-title-number">{{tempIncorrectAnswer.subject.serialNumber}} .</span>
